  ...
  return (
    <main className="min-h-screen bg-surface text-paper/70">
      <div className="max-w-2xl mx-auto px-6 py-16 sm:py-20">
        ...
        <p className="text-sm text-paper/40 mb-10">Last updated: August 28, 2026</p>
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-paper font-semibold text-base mb-2">Information we collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-paper font-semibold text-base mb-2">How we use information</h2>
            <p>
          ...
          <section>
            <h2 className="text-paper font-semibold text-base mb-2">SMS / text messages</h2>
            <p>
              ...
              <strong className="text-paper">STOP</strong> to opt out or{" "}
              <strong className="text-paper">HELP</strong> for help. We do not
          ...
          <section>
            <h2 className="text-paper font-semibold text-base mb-2">Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-paper font-semibold text-base mb-2">Contact</h2>
            <p>
